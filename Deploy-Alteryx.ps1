...
Process {
  ...
  switch ($Action) {
    ...
    # "configure" { Invoke-ConfigureAlteryx -Properties $Properties -Unattended:$Unattended               }
    "install"   { Install-Alteryx         -Properties $Properties -Unattended:$Unattended               }
    # "reload"    { Invoke-ReloadAlteryx    -Properties $Properties -Unattended:$Unattended               }
    ...
    "start"     { Invoke-StartAlteryx     -Properties $Properties                                       }
    "stop"      { Invoke-StopAlteryx      -Properties $Properties                                       }
